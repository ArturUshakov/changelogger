...
```bash
curl -fsSL https://github.com/SolasWyrd/changelogger/releases/latest/download/changelogger-install | sh
```
...
```bash
curl -fsSL https://github.com/SolasWyrd/changelogger/releases/latest/download/changelogger-install | CHANGELOGGER_INSTALL_DIR="$HOME/bin" sh
```
